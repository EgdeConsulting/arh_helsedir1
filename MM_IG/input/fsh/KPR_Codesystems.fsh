...
* ^caseSensitive = true
* #K "Melding for kontinuerlige oppdateringe"
// * #B "Satsvis melding" //
...
* ^caseSensitive = true
* #N "Original" "Ny hendelse"
* #M "KorrigerErstatt" "Korrigering av original hendelse med ny informasjon som erstatter tilsvarende original informasjon"
